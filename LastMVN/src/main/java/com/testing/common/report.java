...
public class report {
	...
	public void sendreport (String resultFile,String startTime)  {
		...
		map.put("emailAccount", "652200567@qq.com");
		map.put("emailPassword", "tqvhvfokuxgabbfb");
		map.put("sendnick", "Ronnie");
		map.put("host", "smtp.qq.com");
		map.put("recievers", "652200567@qq.com");
		map.put("copylist", "245766353@qq.com,3028978180@qq.com");
	...
	public String makeReport(List<Map<String,String>> resultlist) {
		//邮件开头
		String mailstart = "<html><style type=\"text/css\">body{ background:#ffffff; margin:0 auto; padding:0; text-align:left; font-size:12px; font-family: \"微软雅黑\",\"宋体\";}table{ font-size:12px; font-family: \"微软雅黑\",\"宋体\";}.table_c{border:1px solid #ccc;border-collapse:collapse; }.table_c td{border:1px solid #ccc; border-collapse:collapse;}.table_b{border:1px solid #666;border-collapse:collapse; }.table_b td{ border-collapse:collapse; border:1px solid #ccc;}.table_b th{color:#fff; background:#666;}a:link{ color:#3366cc; font-weight:normal; }a:visited { color: #3366cc;}a:hover{ color:#000; }a:active { color:#3366cc; }td{ line-height:20px;}</style><table width=\"650\" border=\"0\" cellspacing=\"0\" align=\"center\" cellpadding=\"0\" style=\"border: #ccc 1px solid;\"><tbody><tr><td><table width=\"650\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"fbfbfb\" style=\"border-bottom: #eeeeee 1px solid;border-top: #cc0000 1px solid;\"><tbody><tr><td width=\"137\"><img src=\"http://img0.ph.126.net/sUlxagIZ7jT5585ZV0BjsA==/6619334877119886603.jpg\" width=\"137\" height=\"80\"></td><td width=\"249\" align=\"center\" style=\"font-size: 12px; color: #999999; padding-top: 26px;\">此信为自动化测试邮件，请不要直接回复。</td></tr></tbody></table><table width=\"592\" border=\"0\" align=\"center\" cellspacing=\"0\" cellpadding=\"0\"><tbody><tr><td align=\"left\"style=\"font-size: 12px; color: #666666; padding-bottom: 6px;\">尊敬的领导,您好！</td></tr></tbody></table>&nbsp;<table width=\"592\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\"><tbody><tr><td style=\"font-size: 14px; color: 333333; font-weight: bold; padding-bottom:15px;\">本测试邮件来自：<font color=\"ff6600\">自动化测试组</font></td></tr><tr><td><table width=\"592\" border=\"0\" align=\"center\" class=\"table_c\" style=\"border-collapse:collapse;\"><tbody><tr><td width=\"100\" height=\"28\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">测试状态</td><td width=\"80\" height=\"28\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">通过率</td><td width=\"100\" height=\"28\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">开始时间</td><td width=\"80\" height=\"28\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">结束时间</td></tr><tr><td height=\"28\" bgcolor=\"#FFFFFF\" align=\"center\" style=\"border:1px solid #ccc;\">status</td><td height=\"28\" bgcolor=\"#FFFFFF\" align=\"center\" style=\"border:1px solid #ccc;\">passrate</td><td height=\"28\" bgcolor=\"#FFFFFF\" align=\"center\" style=\"border:1px solid #ccc;\">starttime</td><td height=\"28\" bgcolor=\"#FFFFFF\" align=\"center\" style=\"border:1px solid #ccc;\">endtime</td></tr></tbody></table></td></tr><tr><td style=\"font-size: 14px; color: 333333; font-weight: bold; padding-bottom:15px;\"><br>测试详情报表</td></tr><tr><td><table width=\"592\" border=\"0\" align=\"center\" class=\"table_c\" style=\"border-collapse:collapse;\"><tbody><tr><td width=\"100\" height=\"28\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">分组信息</td><td width=\"80\" height=\"28\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">用例总数</td><td width=\"80\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">通过数</td><td width=\"80\" align=\"center\" bgcolor=\"#FFFFFF\" style=\"border:1px solid #ccc;\">状态</td></tr>";
		String content = mailstart;
		content = content.replace("Ronnie", "肉肉");
	...
	public static void main(String[] args) {
		...
		//测试： 统计  结果用例，并整合成html，然后发送
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String startTime = df.format(new Date());
		
		report sendTestResult = new report();
		sendTestResult.sendreport("cases/result_HTTPLogin.xlsx", startTime);
	}
