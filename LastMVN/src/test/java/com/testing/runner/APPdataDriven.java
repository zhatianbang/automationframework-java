 ...
 *  5、读取结果用例发送报告
 */
public class APPdataDriven {
	public DataDrivenOfApp web;
...
//通过数据指定的关键字运行，并且断言
  ...
  public void f(String rowNo, String kong,String casename,String keywords,String param1,String param2,String param3,String k1,String k2,String k3,String k4 ) {
	  ...
	  //行数和用例名称输出
	  System.out.println(rowNo+"  "+casename + "  " + runRes);
//	  System.out.println(runRes);
  ...
  public void beforeSuite() {
      ...
      String filename ="APPCasesDataDriven";
	  ...
	  web =new DataDrivenOfApp(resultExcel);
  }
